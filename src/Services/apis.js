...
export const articlesEndPoints = {
  GET_UNIQUE_ARTICLES: BASE_URL + '/api/article/get-unique-articles-from-categories',
  ...
  SEARCH_ARTICLES: BASE_URL + `/api/article/search-articles`
};
...
export const authEndPoints = {
  ...
  ACCEPT_INVITE_REPORTER: (token) => BASE_URL + `/api/auth/accept-invite-reporter/${token}`,
  UPDATE_AVATAR_URL: BASE_URL + `/api/auth/update-avatar-url`
};

export const adminEndPoints = {
  USER_PER_MONTH : BASE_URL + "/api/admin/total-users-per-month",
  ARTICLES_PER_MONTH : BASE_URL + "/api/admin/total-articles-per-month",
  SEARCH_USERS : BASE_URL + "/api/admin/search-users"
}
